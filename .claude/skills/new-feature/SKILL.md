---
name: new-feature
description: Scaffold a new feature — branch from dev, create files per the framework structure, update readme/ flow docs, register in CLAUDE.md. Use whenever a new feature is requested.
---
