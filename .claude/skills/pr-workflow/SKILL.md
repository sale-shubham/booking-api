---
name: pr-workflow
description: Create a pull request — collect branch changes, draft a conventional title + body, verify readme sync, open the PR targeting dev (never merge). Use when asked to create a PR.
---
